...
namespace DXRenderer
{
    ...
    public:
        ...
        static void ExportPixels(_In_ IWICImagingFactory2* fact, unsigned int pixelWidth, unsigned int pixelHeight, _In_ byte* buffer, unsigned int stride, unsigned int countBytes, WICPixelFormatGUID fmt, _In_ IStream* stream);
